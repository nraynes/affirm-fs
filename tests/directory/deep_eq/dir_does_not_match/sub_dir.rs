...
fn additional_file() {
    ...
    let dir_structure = DirStructure::new(temp.env().path())
        ...
        .file_with_contents("f2", "Test content for f2.")
        .file_with_contents("f3", "Test content for f3.")
        .file_with_contents("f4", "Test content for f4.")
        .build();
...
fn additional_dir() {
    ...
    let dir_structure = DirStructure::new(temp.env().path())
        ...
        .dir("d4", |d| {
            d.file_with_contents("d4f1", "Test content for d4f1.")
                .build()
        })
        .file_with_contents("f1", "Test content for f1.")
        .file_with_contents("f2", "Test content for f2.")
...
fn additional_items() {
    ...
    let dir_structure = DirStructure::new(temp.env().path())
        ...
        .dir("d5", |d| {
            d.file_with_contents("d5f1", "Test content for d5f1.")
                .build()
        })
        .file_with_contents("f1", "Test content for f1.")
        .file_with_contents("f2", "Test content for f2.")
        .file_with_contents("f3", "Test content for f3.")
        .file_with_contents("f4", "Test content for f4.")
        .file_with_contents("f5", "Test content for f5.")
        .build();
